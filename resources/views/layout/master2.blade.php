...
<head>
    ...
    <link href="{{asset('template/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css')}}"
        rel="stylesheet">
    <link href="{{asset('template/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css')}}"
        rel="stylesheet">
</head>
                ...
                <div class="left_col scroll-view">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-car"></i>Data Lakalintas <span
                                    ...
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a class="{{ request()->is('admin/jalan') ? 'active' : ''}}"
                                                href="{{route('jalan')}}"><i class="fa fa-road"></i> Jalan</a>
                                        </li>
                                        <li><a class="{{ Route::is('Kasus.index') ? 'active' : ''}}"
                                                href="{{route('Kasus.index')}}"><i class="fa fa-fax"></i> Kasus
                                                Lakalintas</a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-gears"></i>Website Info <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">

                                        <li><a class="{{ Route::is('Web Decsription.index') ? 'active' : ''}}"
                                                href="{{route('Web Decsription.index')}}"><i
                                                    class="fa fa-file-text"></i> Web
                                                Decsription</a>
                                        <li><a class="{{ Route::is('ContactUs.index') ? 'active' : ''}}"
                                                href="{{route('ContactUs.index')}}"><i class="fa fa-phone"></i>Contact
                                                Us</a>
                                        </li>
                                    </ul>
                                </li>
