          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li><a class="{{ request()->is('admin/dashboard') ? 'active' : ''}}" href="{{route('dashboard')}}"><i
                      class="fa fa-home"></i> Dashboard</a>
                </li>
                <li><a class="{{ request()->is('admin/jeniskasus') ? 'active' : ''}}" href="{{route('jeniskasus')}}"><i
                      class="fa fa-book"></i> Jenis Kasus</a>
                </li>
